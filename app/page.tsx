				...
				<div className="container mx-auto py-28 px-4">
					<div className="flex flex-col items-center justify-center space-y-6 text-center max-w-4xl mx-auto">
						...
						<p className="text-xl md:text-2xl text-white/80 max-w-3xl">
							Generate unique NFTs with AI, track their history on-chain, and build upon existing
							creations. Share your experience 🐰
						</p>
									...
									<div className="border rounded-lg p-6 flex items-start space-x-4">
										...
										<div>
											...
											<p className="text-muted-foreground">
												ERC-1155 multi-token standard for efficient batch operations and reduced
												gas costs
											</p>
										</div>
									</div>
